...
@section('meta_title',__('Edit Page'))

@section('page_name',__('Edit Page'))

@section('page_description',__('Edit Page'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Edit Page') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('admin.pages.update',encrypt($page->id)) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" id="name" value="{{ old('name') ?? $page->name }}" placeholder="{{ __('Enter Page Name') }}" class="form-control @error('name') form-control-danger @enderror">
                           <span class="messages">
                                @error('name')
                                    <p class="text-danger error">{{ $message }}</p>
                                @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" id="title" value="{{ old('title') ?? $page->title }}" placeholder="{{ __('Enter Page Title') }}" class="form-control @error('title') form-control-danger @enderror">
                           <span class="messages">
                                @error('title')
                                    <p class="text-danger error">{{ $message }}</p>
                                @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') ?? $page->meta_title }}" placeholder="{{ __('Enter Meta Title') }}" class="form-control @error('meta_title') form-control-danger @enderror">
                            @error('meta_title')
                                <p class="text-danger error">{{ $message }}</p>
                            @else
                                <p class="text-muted">{{ __('') }}</p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="meta_description" id="meta_description" value="{{ old('meta_description') ?? $page->meta_description }}" placeholder="{{ __('Enter Meta Description') }}" class="form-control @error('meta_description') form-control-danger @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="brief_description" id="brief_description" placeholder="{{ __('Enter Brief Description') }}" class="form-control @error('brief_description') form-control-danger @enderror">{{ old('brief_description') ?? $page->brief_description }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" id="description" placeholder="{{ __('Enter Description') }}" class="form-control @error('description') form-control-danger @enderror">{{ old('description') ?? $page->description }}</textarea>
                            @error('description')
                                <p class="text-danger error">{{ $message }}</p>
                            @else
                                <p class="text-muted">{{ __('') }}</p>
